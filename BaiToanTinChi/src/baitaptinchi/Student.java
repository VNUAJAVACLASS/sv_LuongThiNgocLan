...
public class Student extends Human {
	...
	public static void main(String[] args) {
		Student std = new Student("687686", "Le Van Hoa", "K87968");

		Subject sub1 = new Subject("TH03111", "Lt java", 3);
		sub1.setAttendanceMark(8.5f);
		sub1.setMidExamMark(6.8f);
		sub1.setFinalExamMark(7.6f);

		Subject sub2 = new Subject("Th0007", "Tin co soo", 3);
